...
from qr_api.lib_nodes import _scan_orphaned_units, _get_node_build_state, find_system_instance as _fsi
...
def parse_args():
    """Parse CLI arguments."""
    parser = argparse.ArgumentParser(description="quickrobot Quickrobot API Server")
    ...
    parser.add_argument("--mode", choices=["dev", "prod", "dev-update"],
                         ...
                         "dev-update (auto-import + sync checksums)")
...
def api_playbook_content(playbook_id):
    ...
    return success_single({
        ...
        "file_size": pb.get("file_size"),
        "actual_file_size": disk_size,
        "content": content,
    })
