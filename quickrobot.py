...
if __name__ == "__main__":
    ...
    from quickrobot import app, register_routes
    ...
    print(f"[qr] {_VERSION} — LAN Controller API server starting...", flush=True)
